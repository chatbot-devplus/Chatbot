  ...
  return (
    <div className="max-w-md mx-auto p-6 pt-[200px]">
      <div className="flex items-center justify-center">
        <img src={Logo} alt="Centered Image" className="w-20" />
      </div>
      ...
      <span className="text-gray-900 mb-3">Already have an account?</span>
      ...
      >
        ...
        >
          ...
          <path
            fill="#34A853"
            d="M46.27 24.56c0-1.6-.13-3.13-.37-4.56H24v9h12.67c-.88 4.45-3.6 8.21-7.26 10.49l7.89 6.13C43.76 41.29 46.27 33.5 46.27 24.56z"
          />
          <path
            fill="#FBBC05"
            d="M10.78 28.74a14.4 14.4 0 01-7.55-8.48L2.89 13.13a23.95 23.95 0 000 21.74l7.89-6.13z"
          />
          <path
            fill="#EA4335"
            d="M24 46.27c6.5 0 11.92-2.12 15.89-5.78l-7.89-6.13c-2.16 1.45-4.92 2.29-8 2.29-6.5 0-11.87-4.17-13.89-10.04l-7.89 6.13C8.13 40.9 15.14 46.27 24 46.27z"
          />
      ...
      >
        <svg
          ...
          fill="#1877F2"
        >
          <path d="M22.675 0h-21.35C.595 0 0 .593 0 1.326v21.348C0 23.407.595 24 1.325 24h11.495v-9.294H9.69v-3.622h3.13V8.413c0-3.1 1.892-4.788 4.657-4.788 1.324 0 2.462.099 2.794.143v3.24l-1.917.001c-1.504 0-1.795.715-1.795 1.763v2.31h3.587l-.467 3.622h-3.12V24h6.116c.73 0 1.325-.593 1.325-1.326V1.326C24 .593 23.405 0 22.675 0z" />
        </svg>
